  ...
  <div v-if="isFiltersOpen" class="grid grid-cols-5 gap-6 animate-fadeIn">
    ...
    >
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[3].label }}</p>
        <MultiSelect 
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[4].label }}</p>
        <Input
          :id="filters[4].id"
          type="text"
    ...
    >
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[24].label }}</p>
        <Input
          :id="filters[24].id"
          type="text"
          v-model="filters[24].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
    ...
    >
     ...
     <div 
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[30].label }}</p>
        <Input
          :id="filters[30].id"
          type="text"
          v-model="filters[30].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
    ...
    >
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[31].label }}</p>
        <Input
          :id="filters[31].id"
          type="text"
          v-model="filters[31].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[34].label }}</p>
        <Input
          :id="filters[34].id"
          type="text"
          v-model="filters[34].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
    ...
    >
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[37].label }}</p>
        <Input
          :id="filters[37].id"
          type="text"
          v-model="filters[37].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
      ...
      <div 
        class="flex flex-col gap-1"
      >
        <p class="font-bold">{{ filters[38].label }}</p>
        <Input
          :id="filters[38].id"
          type="text"
          v-model="filters[38].value"
          placeholder="..."
          class="p-1 pl-2 text-xs"
        />
      </div>
